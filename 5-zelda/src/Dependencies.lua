...
--require 'src/states/entity/player/PlayerTakesPotState'
...
gFrames = {
    ...
    ['heart'] = GenerateQuads(gTextures['heart'], 8, 8)
}
...
gSounds = {
    ...
    ['pickpot'] = love.audio.newSource('sounds/pickpot.wav', 'static'),
    ['hit-pot'] = love.audio.newSource('sounds/hit_pot.wav', 'static')
}