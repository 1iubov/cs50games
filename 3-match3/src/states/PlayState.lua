    ...
    if self.canInput then
        ...
        if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
            ...
            elseif math.abs(self.highlightedTile.gridX - x) + math.abs(self.highlightedTile.gridY - y) > 1 then
                ...
                local tile2 = self.board.tiles[y][x]
                ...
                :finish(function()
                    self:calculateMatches(tile1, tile2, true)
                end)
            end
        end
    end
...
function PlayState:calculateMatches(tile1, tile2, tilestrue)
    ...
    if matches then
        ...
        Timer.tween(0.25, tilesToFall):finish(function()
            ...
            self:calculateMatches(tile1, tile2, false)
        end)
    ...
    -- if no matches, we can continue playing
        ...
        if tilestrue then
            ...
            -- swap tiles in the tiles table
            self.board.tiles[tile2.gridY][tile2.gridX] =
                    tile2
