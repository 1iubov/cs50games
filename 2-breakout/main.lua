...
function love.load()
    ...
    gSounds = {
        ...
        ['bloked-hit'] = love.audio.newSource('sounds/bloked-hit.wav', 'static'),
        ['multiballs'] = love.audio.newSource('sounds/multiballs.wav', 'static'),
        ['unblocked'] = love.audio.newSource('sounds/unblocked.wav', 'static'),
    }
    ...
    -- global var when key is blocked
    gKeyBlocked = true
