...
gTextures = {
    ...
    ['keys-blocks'] = love.graphics.newImage('graphics/keys_and_locks.png'),
    ['portal'] = love.graphics.newImage('graphics/flags.png'),
    ['flag-portal'] = love.graphics.newImage('graphics/flags.png')
}
...
gFrames = {
    ...
    -- key blocks and keys
    ['keys-blocks'] = GenerateQuads(gTextures['keys-blocks'], 16, 16),

    -- portal
    ['portal'] = GenerateQuads(gTextures['portal'], 16, 48),
    ['flag-portal'] = GenerateQuads(gTextures['portal'], 16, 16)
}
